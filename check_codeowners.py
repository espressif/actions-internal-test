...
CODEOWNERS_PATH = os.path.join('.gitlab', 'CODEOWNERS')
CODEOWNER_GROUP_PREFIX = '@actions-internal-test-codeowners/'
...
def get_all_files() -> List[str]:
    ...
    return subprocess.check_output(['git', 'ls-files']).decode('utf-8').strip().split('\n')
